...
import org.scalatest.{BeforeAndAfterAll, AsyncTestSuite}
...
class AsyncGeminiAPISpec extends AsyncWordSpec with Matchers with BeforeAndAfterAll with AsyncTestSuite {
